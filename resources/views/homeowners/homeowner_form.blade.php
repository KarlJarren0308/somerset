...
<div class="form-group">
   <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">Member Occupation
   </label>
   <div class="col-md-9 col-sm-6 col-xs-12">
...
<div class="form-group">
   <label for="address" class="control-label col-md-3 col-sm-3 col-xs-12">Subdivision Address (Block-Lot)</label>
   <div class="col-md-9 col-sm-6 col-xs-12">
