...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('guest-reservations',['as'=>'guestreservations','uses'=>'reservation\ReservationController@getHomeOwnerReservations']);
    Route::get('guest-reservations/create',['as'=>'guestreserve','uses'=>'reservation\ReservationController@create']);
