...
trait UtilityHelper
{
    ...
    public function getAmenities($id) {
        return $id==null ? AmenitiesModel::all() : AmenitiesModel::findOrFail($id);
    }
    ...
    */
    ...
    public function checkIfDateTimeInRange($dateTimeToCheck, $startDateTime, $endDateTime, $endDateTimeInclusion = false) {
        $startDateTime = strtotime($startDateTime);
        $endDateTime = strtotime($endDateTime);
        $dateTimeToCheck = strtotime($dateTimeToCheck);

        if($endDateTimeInclusion) {
    ...
    public function checkIfDateTimeRangeOverlap($dateTimeStartA, $dateTimeEndA, $dateTimeStartB, $dateTimeEndB) {
        $dateTimeStartA = strtotime($dateTimeStartA);
        $dateTimeEndA = strtotime($dateTimeEndA);
        $dateTimeStartB = strtotime($dateTimeStartB);
        $dateTimeEndB = strtotime($dateTimeEndB);

        return (($dateTimeStartA < $dateTimeEndB) && ($dateTimeEndA > $dateTimeStartB));
    }
}           